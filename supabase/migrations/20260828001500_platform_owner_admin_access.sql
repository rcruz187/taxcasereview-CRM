-- Keep database authorization aligned with the dedicated RomyLabs admin portal.
-- UI owner routing already permits these accounts; platform RPCs must use the same owner set.
