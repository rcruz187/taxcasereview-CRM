...
export const SMS_TEMPLATES = [
  ...
  { label: 'Appointment reminder', body: "Hi {name}, this is a reminder about your upcoming appointment with {firm}. Reply here if you need to reschedule." },
...
export function applySmsTemplate(tpl, fullName) {
  ...
  const firm  = FIRM.name || 'our office'
  return tpl.body.replace(/\{name\}/g, first).replace(/\{firm\}/g, firm)
}
