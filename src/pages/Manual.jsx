...
const MANUAL_SECTIONS = [
  ...
  // ─── IRS TOOLS ──────────────────────────────────────────────────────────────
  {
    ...
    content: [
      ...
      { type: 'h3', text: 'Pulling and uploading transcripts' },
      { type: 'steps', items: [
        { title: 'Download transcript PDF from IRS e-Services or A2A', desc: 'Log into IRS e-Services → Transcript Delivery System (TDS). Select client by SSN/EIN, choose type and tax years. Download as PDF.' },
        { title: 'Client file → IRS Portal tab → Upload Transcript', desc: 'Drag the PDF to the upload area. The parser reads it automatically.' },
        { title: 'Parser extracts key data', desc: 'Built-in parser (pdf.js + rule-based, no AI cost) extracts: balance owed, CSED dates, TC codes, penalty & interest breakdown, assessment history, and lien/levy status.' },
        { title: 'Data populates the compliance record', desc: 'CSED dates, total balance, and assessment history appear in the compliance record section.' },
      ]},
