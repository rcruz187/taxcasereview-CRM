...
export default function Settings() {
  ...
  async function changePassword() {
    ...
    if (pw.next.length < 6) return showToast('Password must be at least 6 characters', 'err')
    setSaving(true)
        ...
        <div className="card">
          ...
          <div style={{ padding: '0 20px 20px' }}>
            ...
            <div style={{ color: 'var(--t3)', fontSize: 13 }}>
              To add or remove team members, go to your Supabase dashboard → Authentication → Users.
              Full user management UI coming soon.
            </div>
          </div>
        </div>
      )}
