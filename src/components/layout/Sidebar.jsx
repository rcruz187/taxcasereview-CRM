...
const LOGO = `data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 120 114'><polygon points='60,4 108,30 108,90 60,116 12,90 12,30' fill='%230f2150' stroke='%231e3a6e' stroke-width='1.5'/><rect x='28' y='72' width='13' height='28' rx='2' fill='%23b91c1c'/><rect x='45' y='58' width='13' height='42' rx='2' fill='%23dc2626'/><rect x='62' y='64' width='13' height='36' rx='2' fill='%23991b1b'/><rect x='79' y='70' width='11' height='30' rx='2' fill='%231d4ed8'/><path d='M52 48 L72 28 L80 36 L84 20 L68 24 L76 32 L56 52Z' fill='%23ef4444'/><path d='M35 35 Q60 10 85 35' fill='none' stroke='%231d4ed8' stroke-width='7' stroke-linecap='round'/><rect x='50' y='44' width='20' height='20' rx='3' fill='%231e3a6e' stroke='%231d4ed8' stroke-width='1.5'/><path d='M55 49 L65 59 M65 49 L55 59' stroke='%2393c5fd' stroke-width='2.5' stroke-linecap='round' fill='none'/></svg>`
